      ...
      <DeferCaseBody>
        ...
        <section className="pb-12 mb-12 border-b border-separator">
          ...
          <div className="space-y-4 max-w-[720px]">
            <p>
              <strong className="font-medium text-foreground">LastPass</strong>{" "}
              is a password and identity management platform used by over
              100,000 businesses — primarily small and mid-size organizations.
              It helps teams secure credentials through encrypted vaults,
              password generation, secure sharing, and single sign-on.
            </p>
            <p>
            ...
            <p>
              ...
              access governance — giving IT admins reasons to stay that go
            ...
            <p>
              ...
              (internally called &quot;UAC&quot;) is where IT admins manage
              their organization&apos;s LastPass deployment: provisioning users,
              configuring security policies, monitoring password health,
              managing shared folders, and — with the Business Max tier —
              tracking SaaS usage and enforcing access controls.
            </p>
            <p>
              The console&apos;s landing page is the first screen admins see
              when they log in. It&apos;s the single most valuable piece of real
              estate in the product — and the focus of this project.
            </p>
          </div>
        </section>
        ...
        <section className="pb-12 mb-12 border-b border-separator">
          ...
          <div className="space-y-4 max-w-[720px]">
            <p>
              ...
              the Admin Console&apos;s landing page still showed nothing more
              than an adoption chart (users invited, users signed up, users who
              are active). The first screen admins saw represented a fraction of
              what the product could now do.
            </p>
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li>
                ...
                The page treated &quot;how many users activated&quot; as the
                whole story, ignoring security posture, risk, and ongoing
                management.
              </li>
              <li>
                <strong className="font-medium text-foreground">
            ...
            <aside className="border-l-2 border-accent-border bg-accent-muted pl-5 pr-4 py-4 my-6">
              <p>
                <strong className="font-medium text-foreground">
                  The overarching goal:
                </strong>{" "}
                Provide an at-a-glance view of the current state of the
                product(s) and surface critical actions the admin should take
                immediately.
              </p>
            </aside>
          </div>
          ...
          <div className="space-y-12 max-w-[720px]">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-5">
              ...
              <div className="space-y-4 min-w-0">
                ...
                <p>
                  We started with a cross-functional planning session to align
                  on the problem space, followed by a Design Studio workshop
                  with 10 team members — designers, PMs, engineers, and content
                  designers. In two rounds of individual sketching and group
                  critique, the team explored modular layouts, notification
                  centers, and &quot;tip of the iceberg&quot; approaches.
                </p>
                <p>
                  We defined primary objectives: increase feature and seat
                  adoption, improve Security Score by driving remediation,
                  reduce SaaS risk through continuous monitoring, and provide
                ...
                <p>
                  ...
                  <em>
                    &quot;Admins will be able to say: let me check the overview
                    to see if there&apos;s anything urgent going on with
                    LastPass.&quot;
                  </em>{" "}
                  The top fear:{" "}
                  <em>
                    &quot;Unclear purpose — the overview page tries to do too
                    many things at once because it&apos;s the best real estate
                    in the UAC.&quot;
                  </em>
                </p>
              </div>
              ...
              <div className="space-y-4 min-w-0">
                ...
                <div className="border-t border-separator pt-4">
                  ...
                  <p>
                    ...
                    &quot;7 breached passwords&quot; is meaningless; &quot;7
                    users with breached passwords — here they are&quot; is
                    actionable.
                  </p>
                </div>
              </div>
                ...
                <ul className="space-y-6">
                  <li className="border-b border-separator pb-4">
                    ...
                    <p className="text-secondary-foreground">
                      This page should not be a metrics dashboard. It should be
                      a starting point for action — a place that tells you what
                  ...
                  <li className="border-b border-separator pb-4">
                    ...
                    <p className="text-secondary-foreground">
                      The landing experience should move admins toward the
                      overall goal of LastPass: improving organizational
                      security posture.
                    </p>
                  </li>
                  <li className="border-b border-separator pb-4">
                  ...
                  <li className="border-b border-separator pb-4">
                    ...
                    <p className="text-secondary-foreground">
                      Every piece of information shown should lead to a clear
                      next step. No dead-end data.
                    </p>
                  </li>
                  <li className="border-b border-separator pb-4">
                    <p className="font-medium text-foreground mb-1">
                  ...
                  <li className="border-b border-separator pb-4">
                    ...
                    <p className="text-secondary-foreground">
                      Every metric should resolve to a list of named users.
                      Admins don&apos;t manage numbers; they manage people.
                    </p>
                  </li>
                  <li>
                    <p className="font-medium text-foreground mb-1">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-5">
              ...
              <div className="space-y-4 min-w-0">
                ...
                <p>
                  ...
                  wasn&apos;t to pick a winner immediately, but to map the
                  design space and understand the tradeoffs. Each concept
                  started from the same research but asked a different question.
                </p>
                ...
                <ul className="list-disc pl-5 space-y-2">
                  <li>
                    ...
                    of what changed since the admin&apos;s last login, with
                    every referenced item hyperlinked to a deep-dive
                  </li>
                  <li>
                    A prioritized{" "}
                    <strong className="font-medium text-foreground">
                ...
                <p>
                  Admins asked for &quot;riskiest users&quot; and &quot;users
                  with password issues&quot; — questions about <em>people</em>,
                  not metrics. This concept makes the landing page a smarter
                  version of user management itself.
                </p>
                <ul className="list-disc pl-5 space-y-2">
                  <li>
                ...
                <p>
                  ...
                  without confidence they&apos;ve checked everything. This
                  concept reframes the landing page as a{" "}
                  <strong className="font-medium text-foreground">
                ...
                <figure className="my-6">
                  <p className="text-secondary-foreground">
                    Wireframe explorations: Briefing concept, People Map
                    concept, Check-In workflow, and early onboarding experience.{" "}
                    <a
                ...
                <div className="border-t border-separator pt-4 space-y-3">
                  ...
                  <p>
                    ...
                    received the most votes and resonated strongly — but the
                    team noted it felt like &quot;a different project,&quot;
                    closer to a reimagined Users page than a landing experience.
                  ...
                  <p>
                    ...
                    was seen as the most pragmatic starting point and closest to
                    a buildable landing experience.
                  </p>
                  <p>
                    <strong className="font-medium text-foreground">
                      The Security Review
                ...
                <div className="border-t border-separator pt-4">
                  ...
                  <p>
                    ...
                    every metric resolves to a user list. The Security Review
                    was deferred as a potential future feature. This hybrid
                    approach serves both the admin who arrives with a specific
                    task (the reactive majority) and the admin who wants to
                    assess overall posture (the proactive minority).
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-5">
              ...
              <div className="space-y-4 min-w-0">
                ...
                <p>
                  We conducted 7 in-depth discovery interviews with
                  Business-tier admins to understand <em>why</em> they open the
                  Admin Console and what they&apos;re thinking when they land.
                  This was the most consequential research phase of the project.
                </p>
                <div className="border-t border-separator pt-4 space-y-3">
                  <p className="text-sm uppercase tracking-[0.06em] text-tertiary-foreground">
                  ...
                  <ol className="list-decimal pl-5 space-y-2">
                    ...
                    <li>
                      ...
                      — federation rollout, policy review. Episodic but
                      intensive.
                    </li>
                    <li>
                      <strong className="font-medium text-foreground">
                ...
                <p>
                  ...
                  accounts), and a security score that showed a number without
                  any guidance on how to improve it.
                </p>
                <aside className="border-l-2 border-accent-border bg-accent-muted pl-5 pr-4 py-4">
                  <p>
                    <strong className="font-medium text-foreground">
                      Key reframe:
                    </strong>{" "}
                    Most visits are <em>reactive</em>, not proactive. Admins
                    arrive with a specific person in mind — &quot;Jamie is
                    locked out&quot; — not to browse a dashboard. The landing
                    page must serve this reactive mode first and fast.
                  </p>
                </aside>
                <div className="border-t border-separator pt-4">
                  <p className="text-sm uppercase tracking-[0.06em] text-tertiary-foreground mb-2">
                  ...
                  <p>
                    This research led to three major design changes: (1) adding
                    a{" "}
                    <strong className="font-medium text-foreground">
                      user search
                    </strong>{" "}
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-5">
              ...
              <div className="space-y-4 min-w-0">
                ...
                <p>
                  ...
                  — a name chosen to signal its purpose: this is where you come
                  to take action, not to stare at charts.
                </p>
                ...
                <ul className="list-disc pl-5 space-y-2">
                  <li>
                    ...
                    at the top — a text field that acts as both a search bar and
                    a natural language interface, with common JTBD actions as
                    quick prompts below it
                  </li>
                  <li>
                    <strong className="font-medium text-foreground">
                  ...
                  <li>
                    ...
                    usage rate, Apps with alerts) with sparklines showing
                    trends, plus an AI-generated narrative summary
                  </li>
                </ul>
                <figure className="my-6">
                  <p className="text-secondary-foreground">
              ...
              <div className="space-y-4 min-w-0">
                ...
                <div className="border-t border-separator pt-4 space-y-3">
                  ...
                  <p>
                    ...
                    Participants didn&apos;t notice the section without
                    scrolling. When they did engage, high-priority updates (like
                    a security score drop) felt like they belonged higher on the
                    page.
                  </p>
                </div>
                <p>
                ...
                <p>
                  ...
                  locked-out users, unauthorized access attempts, password
                  resets, directory sync issues, and integration errors.
                </p>
              </div>
            </div>
              ...
              <div className="space-y-4 min-w-0">
                ...
                <ul className="list-disc pl-5 space-y-2">
                  <li>
                    ...
                    across the product — including data governance, audit
                    trails, and an on/off control for regulated industries. The
                    search bar was simplified to a plain user search.
                  </li>
                  <li>
                    <strong className="font-medium text-foreground">
                    ...
                    &apos;Aha!&apos; moment&quot; — especially for new admins.
                    The question of where the admin getting-started experience
                    fits into the page structure was flagged as a dependency.
                  </li>
                  <li>
                    <strong className="font-medium text-foreground">
                    ...
                    details live in dedicated pages (Adoption Dashboard,
                    Security Dashboard, Reports). Several metric views proposed
                    by stakeholders were better suited to those dedicated pages.
                  </li>
                </ul>
                <div className="border-t border-separator pt-4">
                  <p className="text-sm uppercase tracking-[0.06em] text-tertiary-foreground mb-2">
                  ...
                  <p>
                    ...
                    metric widgets. The page should help admins achieve their
                    goal <em>and</em> provide a glanceable status, not force
                    them to wade through data.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-5">
              ...
              <div className="space-y-4 min-w-0">
                ...
                <p>
                  ...
                  notification queue, and time-anchored metrics — while
                ...
                <ul className="list-disc pl-5 space-y-2">
                  ...
                  <li>
                    ...
                    refined with clearer action categories (Security,
                    Recommended) and richer inline actions (view affected users,
                    compose email, view policy).
                  </li>
                  <li>
                    <strong className="font-medium text-foreground">
          ...
          <div className="space-y-4 max-w-[720px]">
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li>
                ...
                that admins would skip the page. In testing, participants
                engaged with the content rather than navigating away.
              </li>
              <li>
                <strong className="font-medium text-foreground">
        ...
        <section className="pb-12">
          ...
          <div className="space-y-4 max-w-[720px]">
            <p>
              ...
              arrive with a specific task and want to leave quickly.
              Stakeholders wanted &quot;Aha!&quot; moments that surface the
              product&apos;s value. Both are valid — the design challenge was
              honoring both without diluting either. Progressive disclosure
              became the answer: a simple, focused surface layer that rewards
              exploration without demanding it.
            </p>
            ...
            <p>
              ...
              changed or what needs action? If the answer was no — if it was
              there for convenience, discoverability, or to fill space — it was
              fighting the page&apos;s core purpose.
            </p>
            <h3 className="pt-4 text-lg xl:text-xl font-medium">
              When to defer AI
            </h3>
            <p>
              ...
              half-formed was the right call, even though it simplified the
            ...
            <aside className="mt-8 border border-separator rounded-[20px] bg-accent-muted px-6 py-5 text-center">
              ...
              <p>
                ...
                through final stakeholder alignment, engineering handoff,
                implementation, and post-launch measurement.
              </p>
            </aside>
          </div>
        </section>
