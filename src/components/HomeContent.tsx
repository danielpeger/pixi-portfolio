        ...
        <div className="max-w-[612px] md:max-w-[540px] xl:max-w-[640px] mx-auto md:ml-0 px-8 md:pl-0 md:pr-[72px] md:mt-16 mb-16">
          ...
          <div className="mb-8">
            ...
            <p>
              ...
              sense of complexity. I’m a purpose-driven generalist, who works to
              see human potential actualized, envisioning a world where
          ...
          <div>
            ...
            <p>
              When not at my desk you'll find me out in nature, with family and
              friends, in the kitchen, in the swimming pool, or in the cinema.
            </p>
          </div>
        </div>
      </section>
